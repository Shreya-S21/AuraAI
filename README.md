...
- Real Face Mesh Analysis (head pose, gaze direction, blink detection)
- Smart Taste Profile with AI-generated persona and insights
- Live behavioral recommendations that update as you browse
- Beautiful dark modern UI with smooth animations
